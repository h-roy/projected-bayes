...
from src.losses import cross_entropy_loss_per_datapoint, accuracy_preds, nll
from src.helper import calculate_exact_ggn, load_obj, tree_random_normal_like, compute_num_params
from src.sampling import sample_loss_projections_dataloader, vectorize_nn
...
if __name__ == "__main__":
    ...
    os.makedirs(f"./checkpoints/loss_kernel_samples/{args.dataset}/{args.model}", exist_ok=True)
    ...
    save_path = f"./checkpoints/loss_kernel_samples/{args.dataset}/{args.model}/{save_name}"
