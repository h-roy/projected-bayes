...
python experiments/sample_classification_ood.py --dataset FMNIST --model LeNet --checkpoint_path ./checkpoints/FMNIST/LeNet_FMNIST_0_params  --num_samples 30 --num_iterations 1000 --sample_batch_size 16 --macro_batch_size -1 --sample_seed 0 --run_name fmnist_ood --num_ood_examples 1000

python experiments/sample_classification.py --dataset FMNIST --model LeNet --checkpoint_path ./checkpoints/FMNIST/LeNet_FMNIST_0_params  --num_samples 30 --num_iterations 1000 --sample_batch_size 16 --macro_batch_size -1 --sample_seed 0 --run_name fmnist_samples --vmap_dim 15
