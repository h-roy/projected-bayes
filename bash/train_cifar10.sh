...
python experiments/train_classification.py --batch_size 200 --n_epochs 1000 --lr_scheduler --model ResNet_small --dataset CIFAR-10 --trainer Classification --run_name resnet --seed 0
python experiments/train_classification.py --batch_size 200 --n_epochs 1000 --lr_scheduler --model ResNet_small --dataset CIFAR-10 --trainer Classification --run_name resnet --seed 1
python experiments/train_classification.py --batch_size 200 --n_epochs 1000 --lr_scheduler --model ResNet_small --dataset CIFAR-10 --trainer Classification --run_name resnet --seed 2
