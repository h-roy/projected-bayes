...
python experiments/train_classification.py --batch_size 200 --n_epochs 500 --lr_scheduler --model ResNet_small --dataset CIFAR-10 --trainer Classification --run_name CIFAR10 --seed 0
python experiments/train_classification.py --batch_size 200 --n_epochs 500 --lr_scheduler --model ResNet_small --dataset CIFAR-10 --trainer Classification --run_name CIFAR10 --seed 1
python experiments/train_classification.py --batch_size 200 --n_epochs 500 --lr_scheduler --model ResNet_small --dataset CIFAR-10 --trainer Classification --run_name CIFAR10 --seed 2
